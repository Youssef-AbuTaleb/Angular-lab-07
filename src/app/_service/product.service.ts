...
export class ProductService {
  ...
  setProductData(product: IProduct) {
    this.addedProductCart.next(product);
  }

  getProductData() {
    return this.addedProductCart.asObservable();
  }

  setRemovedProductData(product: IProduct) {
    this.removedProductCart.next(product);
  }

  getRemovedProductData() {
    return this.removedProductCart.asObservable();
  }
